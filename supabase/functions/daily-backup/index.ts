...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const summaryHtml = `
      ...
      <p>Rahe Kaba — সকল টেবিলের CSV ব্যাকআপ</p>
      ...
      <p style="margin-top:16px; color:#666; font-size:12px;">Auto-generated by Rahe Kaba backup system</p>
    `;
    ...
    const emailPayload: Record<string, unknown> = {
      ...
      to: [BACKUP_EMAIL],
      subject: `📦 Rahe Kaba Daily Backup — ${today}`,
      html: summaryHtml,
