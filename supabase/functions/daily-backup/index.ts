...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const summaryHtml = `
      ...
      <p>Manasik Travel Hub — সকল টেবিলের CSV ব্যাকআপ</p>
      ...
      <p style="margin-top:16px; color:#666; font-size:12px;">Auto-generated by Manasik Travel Hub backup system</p>
    `;
    ...
    const emailPayload: Record<string, unknown> = {
      ...
      to: [BACKUP_EMAIL],
      subject: `📦 Manasik Travel Hub Daily Backup — ${today}`,
      html: summaryHtml,
